...
- Блок 1 -- знакомство с данными и их обработка,
- Блок 2 -- работа с геоданными,
- Блок 3 -- базовая модель ARIMA,
- Блок 4 -- кластеризация географических зон и ARIMA для каждой из них,
- Блок 5 -- линейная модель,
- Блок 6 -- финальная модель,
- Блок 7 -- лаконичная демонстрация результатов проекта.
